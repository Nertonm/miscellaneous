...
" Redimensionar telas com atalhos
    ...
    " Movimentar entre as telas divididas (Sem Leader para agilidade)
    nnoremap <C-h> <C-w>h
    nnoremap <C-j> <C-w>j
    nnoremap <C-k> <C-w>k
    nnoremap <C-l> <C-w>l
...
" -----------------------------------------------------------------------------
    hi statusline gui=bold guibg=#33ccff guifg=#1a1a1a
    hi statuslinenc gui=NONE cterm=NONE guibg=#595959 guifg=#abb2bf
    hi StatusLineMode gui=bold guibg=#ff9933 guifg=#1a1a1a
    hi StatusLineGitBranch gui=bold guifg=#33ccff
...
" -----------------------------------------------------------------------------
    augroup ModeEvents
        autocmd!
        " Quando entra no modo de inserção (Azul/Ciano)
        au InsertEnter * hi statusline guibg=#33ccff guifg=#1a1a1a
        " Quando sai do modo de inserção (Volta ao padrão)
        au InsertLeavePre * hi statusline guibg=#33ccff guifg=#1a1a1a
        " Quando entra em modos visuais (Laranja)
        au ModeChanged *:[vV\x16]* hi statusline guibg=#ff9933 guifg=#1a1a1a
        au ModeChanged [vV\x16]*:* hi statusline guibg=#33ccff guifg=#1a1a1a
        " Quando entra no modo de substituição (Vermelho Neon)
        au ModeChanged *:[R]* hi statusline guibg=#ff4d4d guifg=#1a1a1a
        au ModeChanged [R]* hi statusline guibg=#33ccff guifg=#1a1a1a
    augroup end
